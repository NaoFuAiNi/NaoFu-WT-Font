...
copy /Y "NaoFu_WT_Customize_Font_2.10_new.exe" "NaoFu WT Customize Font 2.10.exe" >nul 2>&1 && del "NaoFu_WT_Customize_Font_2.10_new.exe"
echo 构建成功: NaoFu WT Customize Font 2.10.exe
