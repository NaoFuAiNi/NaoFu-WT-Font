...
会依次：1）编译 C 主程序到 `debug\NaoFu WT Customize Font 2.10.exe`；2）编译 Launcher (Debug)，并将 C 程序与 font 等复制到 `Launcher\bin\Debug\net8.0-windows\`。完成后直接运行该目录下的 **NaoFu WT Hub 2.10** 即可。
