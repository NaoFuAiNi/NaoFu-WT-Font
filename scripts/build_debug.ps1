# NaoFu WT Font 2.10 - Debug build (C then Launcher)
...
Write-Host "=== 1/3 Building C (NaoFu WT Customize Font 2.10.exe) ===" -ForegroundColor Cyan
Push-Location $debug
try {
...
Write-Host "Done. Run: debug\Launcher\bin\Debug\net8.0-windows\NaoFu WT Hub 2.10.exe" -ForegroundColor Green
